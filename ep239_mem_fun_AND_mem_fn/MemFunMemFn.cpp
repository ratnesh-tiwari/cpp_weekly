 ...
 *
 * 	mem_fun is deprecaed in c++11 and removed in c++11
 * 	Possible rason for this could be because unary_functiona and binary_function were deprecated in c++11 and removed in c++17. So similar
 * 	action were taken with mem_fun because it's return type mem_fun_t and mem_fun1_t are inheritaed from unary_functiona and binary_function.
 *
